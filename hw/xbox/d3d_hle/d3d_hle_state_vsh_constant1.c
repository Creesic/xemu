...
extern void d3d_hle_device_set_vertex_shader_constant1_gen_unused(void);
...
void d3d_hle_device_set_vertex_shader_constant1(void)
{
    ...
    if (!d3d_hle_guest_native_active()) {
        d3d_hle_device_set_vertex_shader_constant1_gen_unused();
        return;
    }
    ...
    d3d_hle_guest_set_vertex_shader_constant(
        start_register, constant_data_va, 1);
}
